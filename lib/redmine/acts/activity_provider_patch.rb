        ...
        base.class_eval do
          ...
          def find_events_with_query(event_type, user, from, to, options)
            ...
            if !scope
              ...
              logger.warn "acts_as_activity_provider with implicit :scope option is deprecated. Please pass a scope on the #{self.name} as a proc."
            end
            ...
            if provider_options.has_key?(:permission)
              ...
              logger.warn "acts_as_activity_provider with implicit :permission option is deprecated. Add a visible scope to the #{self.name} model or use explicit :permission option."
